...
using DXApplication2.Modul_Banka;
using System;
...
{
    public partial class tblKasaAcilisDuzen : DevExpress.XtraEditors.XtraForm
    {
        ...
        string ID1 = "KS";
        int kasaID = -1;
        public tblKasaAcilisDuzen()
        {
            InitializeComponent();
        }

        private void tblKasaAcilisDuzen_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void tblKasaAcilisDuzen_Load(object sender, EventArgs e)
        {
        ...
        void YeniKaydet()
        {
            ...
            try
            {
                ...
                Temizle();
                Listele();
                frmKasaListesi frmAna = (frmKasaListesi)System.Windows.Forms.Application.OpenForms["frmKasaListesi"];

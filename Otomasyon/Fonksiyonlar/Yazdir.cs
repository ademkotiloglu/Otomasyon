...
namespace DXApplication2.Fonksiyonlar
{
    internal class Yazdir
    {
        ...
        public void YazdirmayaBasla()
        {
            ...
            {
                MessageBox.Show(IslemNo.ToString());
            }
        ...
        private void Pd_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            var isyeri = db.TBL_AYARLAR.FirstOrDefault();
            var liste = db.TBL_HIZLISATISYAP.Where(x => x.IslemNo == IslemNo).ToList();
            if (isyeri!=null &&liste!=null)
            {
                ...
                RectangleF rcUnvanKonum = new Rectangle(0, 20, 220,20);
                ...
                e.Graphics.DrawString("TOPLAM :" +geneltoplam.ToString("C2"), fontbilgi, Brushes.Black, new Point(132, yukseklik+20));
                e.Graphics.DrawString("-------------------------------------------------------------", fontbilgi, Brushes.Black, new Point(5, yukseklik+40));
                e.Graphics.DrawString("MALİ DEĞERİ YOKTUR", fontbilgi, Brushes.Black, new Point(5, yukseklik+60));
